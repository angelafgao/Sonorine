...
source_path = '../Processed/Really_cropped/Sonorine_%03d/sonorine_%03d_%03d_%d.tiff';
dest_path = '../Processed/Really_cropped_downsampled/Down%d/Sonorine_%03d/sonorine_%03d_%03d_%d.tiff';
...
for i = 1:120 % iterates over all sonorines
    for down = 0:7 % iterates over all downsampling levels
        ...
        for rot = 0:3
            for num = 1:2
                if down == 0
                    img = imread(sprintf(source_path, i, i, rot*90, num));
                else
                    img = imread(sprintf(dest_path, down, i, i, rot*90, num));
                end
            ...
            imwrite(img_down, sprintf(dest_path, down+1, i, i, rot*90, num));
            end
        end  
